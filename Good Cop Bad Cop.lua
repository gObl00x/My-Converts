...
-- Script Source
script=game:GetObjects("rbxassetid://126958896179973")[1].Template
--//====================================================\\--
--||     GOOD COP BAD COP;Converted/Edited by gObl00x (U don't take credits) --
--\\====================================================//--
...
while true do
	...
	sick.SoundId = "rbxassetid://1836262425"
	sick.Looped = true
	sick.Pitch = 1
	sick.Volume = 4
	sick.Playing = true
