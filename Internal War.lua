...
-- Script Source
script=game:GetObjects("rbxassetid://2967724627")[1]["FakeMouseMainConversion"]
-- Soundtrack
if not isfile("Internal.mp3") then 
	writefile("Internal.mp3",game:HttpGet("https://github.com/gObl00x/Soundtracks/raw/refs/heads/main/Internal.mp3"))
 end
--//====================================================\\--
--||			     BASIS
--\\====================================================//--
...
while true do
	...
	sick.SoundId = getcustomasset("Internal.mp3")
	sick.Looped = true
	sick.Pitch = 1
	sick.Volume = 1.5
