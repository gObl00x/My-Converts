...
-- Script Source
script=game:GetObjects("rbxassetid://2945816118")[1]._ZVN
-- Soundtrack
 if not isfile("Chara.mp3") then 
	writefile("Chara.mp3",game:HttpGet("https://github.com/gObl00x/Soundtracks/raw/refs/heads/main/Chara.mp3"))
 end
...
local Music = Instance.new("Sound")
 Music.Name = "Music"
  Music.Parent = Torso
 Music.SoundId = getcustomasset("Chara.mp3")
Music.Volume = 3
local WalkSpeed = 8
local MaxSouls = 100
local MaxHealth = 500 
