...
if not isfile("Puppet Master.mp3") then 
	writefile("Puppet Master.mp3",game:HttpGet("https://github.com/gObl00x/Soundtracks/raw/refs/heads/main/Puppet%20Master.mp3"))
 end
...
Music.Name = "Music"
Music.SoundId = getcustomasset("Puppet Master.mp3")
Music.Parent = Root
Music:Play()
