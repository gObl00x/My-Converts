...
prepareyourself.SoundId = "rbxassetid://234659695"
...
while true do
    ...
    if true then
       ...
       humanoid.Health = 1e100
        if(not Character:FindFirstChildOfClass'ForceField')then Instance.new("ForceField",Character).Visible = false end
    end
end
