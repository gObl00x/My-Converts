...
-- Credits to CKbackup ---------
   ...
   -- Source Script--
script=game:GetObjects("rbxassetid://4581573037")[1]._ZVN

-- Soundtrack
if not isfile("Sin.mp3") then 
	writefile("Sin.mp3",game:HttpGet("https://github.com/gObl00x/Soundtracks/raw/refs/heads/main/Sin.mp3"))
 end
...
moosick.SoundId = getcustomasset("Sin.mp3")
