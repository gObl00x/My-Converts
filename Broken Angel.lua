...
-- Script Source
script=game:GetObjects("rbxassetid://6015754450")[1].Convert
-- Soundtrack
if not isfile("Broken Angel.mp3") then 
	writefile("Broken Angel.mp3",game:HttpGet("https://github.com/gObl00x/Soundtracks/raw/refs/heads/main/Broken%20Angel.mp3"))
 end

		-- Created by Nebula_Zorua --
		  -- Some epik texts
-- The Broken Angel --
-- You think this is the end? FOOLS! --
-- Discord: Nebula the Zorua#6969
-- Youtube: https://www.youtube.com/channel/UCo9oU9dCw8jnuVLuy4_SATA
    -- A warning for fun lolxd
warn([[
	-> THE BROKEN ANGEL <-
		Ahahah... Ahahahahah..
...
local Muted = false
 local Music = Instance.new("Sound")
  Music.Name = "Music"
    Music.SoundId = getcustomasset("Broken Angel.mp3")
       Music.Parent = Char
         Music.Volume = 3
...
local LEye = New("Part",Head,"LEye",{BrickColor = BrickColor.new("Institutional white"),Material = Enum.Material.Neon,FormFactor = Enum.FormFactor.Symmetric,Size = Vector3.new(0.153750196, 0.230625242, 0.0820000842),CFrame = CFrame.new(66.609169, 34.6919556, 18.2405739, 0.999872506, 0.000897944381, -0.015586175, -3.5254098e-07, 0.998357356, 0.057491634, 0.0156121058, -0.0574860275, 0.998224318),TopSurface = Enum.SurfaceType.Smooth,Color = Color3.new(0.972549, 0.972549, 0.972549),})
local Mosh = New("SpecialMesh",LEye,"Mesh",{MeshType = Enum.MeshType.Sphere,})
local mot = New("Motor",LEye,"mot",{Part0 = LEye,Part1 = Head,C0 = CFrame.new(0, 0, 0, 0.999876261, -3.55915546e-07, 0.0156121058, 0.000897933613, 0.998349726, -0.0574853383, -0.0155862337, 0.0574918836, 0.998224318),C1 = CFrame.new(-0.195907593, 0.223518372, -0.543916702, 0.999876261, -3.55915546e-07, 0.0156121058, 0.000897933613, 0.998349726, -0.0574853383, -0.0155862337, 0.0574918836, 0.998224318),})
local REye = New("Part",Head,"REye",{BrickColor = BrickColor.new("Institutional white"),Material = Enum.Material.Neon,FormFactor = Enum.FormFactor.Symmetric,Size = Vector3.new(0.153750196, 0.230625242, 0.0820000842),CFrame = CFrame.new(66.9891586, 34.6919518, 18.2505741, 0.999872506, 0.000897944381, -0.015586175, -3.5254098e-07, 0.998357356, 0.057491634, 0.0156121058, -0.0574860275, 0.998224318),TopSurface = Enum.SurfaceType.Smooth,Color = Color3.new(0.972549, 0.972549, 0.972549),})
local Mosh = New("SpecialMesh",REye,"Mesh",{MeshType = Enum.MeshType.Sphere,})
local mot = New("Motor",REye,"mot",{Part0 = REye,Part1 = Head,C0 = CFrame.new(0, 0, 0, 0.999876261, -3.55915546e-07, 0.0156121058, 0.000897933613, 0.998349726, -0.0574853383, -0.0155862337, 0.0574918836, 0.998224318),C1 = CFrame.new(0.184196472, 0.22328186, -0.539857864, 0.999876261, -3.55915546e-07, 0.0156121058, 0.000897933613, 0.998349726, -0.0574853383, -0.0155862337, 0.0574918836, 0.998224318),})
...
for i = 1, 105,5 do
	local part = NewInstance("Part",Halo,{BrickColor=BrickColor.new"Really black",Material=Enum.Material.Neon,Size=V3.N(.05,.1,.05),Anchored=false,CanCollide=false,Locked=true,Transparency=0})
...
for aa = 1, 3 do
	local lastFeather;
	FeatherWelds[1][aa] = {}
	for i = 1, M.RNG(3,7)+inc do
		local feather = NewInstance("Part",Wings,{Transparency=M.RNG(0,50)/100,CustomPhysicalProperties=PhysicalProperties.new(0,0,0,0,0),TopSurface=10,BottomSurface=10,Size=V3.N(2,.5,.75),CanCollide=false,Color=C3.N(0,0,0),Material=Enum.Material.Neon})
		if(lastFeather)then
...
for aa = 5,6 do
	...
	FeatherWelds[2][aa] = {}
	for i = 1, M.RNG(3,7)+inc do
		local feather = NewInstance("Part",Wings,{CustomPhysicalProperties=PhysicalProperties.new(0,0,0,0,0),TopSurface=10,BottomSurface=10,Size=V3.N(2,.5,.75),CanCollide=false,Color=C3.N(0,0,0),Material=Enum.Material.Neon})
		if(i ~= M.RNG(1,7))then
			if(lastFeather)then
				table.insert(FeatherWelds[2][aa],NewInstance("Weld",feather,{Part0=lastFeather,Part1=feather,C0=CF.N(-.5,.25,0)*CF.A(0,0,M.R(5))}))
			else
