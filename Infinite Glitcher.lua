...
-- Credits to whoever the hell made the original Script ---------
   ...
   -- Definitions --
script=game:GetObjects("rbxassetid://4722218391")[1].ig
...
FELOADLIBRARY = {}
loadstring(game:GetObjects("rbxassetid://4722218391")[1].Source)()
...
ned1.TextScaled = true
ned1.TextStrokeTransparency = 0
ned1.Text = "Information: This guy was a plumber on a adventure to find his princess called Peach, He searched her In castles every day, Luigi helped him, and (MESSAGE DIRTY, CANT READ, LEFT MESSAGE: He Was also making a dance, after 1 hour of making it and resting he got memed."
ned1.TextSize = 24
ned1.Rotation = 1
ned1.TextXAlignment = "Right"
...
Part169.BrickColor = MAINRUINCOLOR
...
Part173.BrickColor = MAINRUINCOLOR
...
Part189.BrickColor = MAINRUINCOLOR
...
Part199.brickColor = MAINRUINCOLOR
...
Part213.BrickColor = MAINRUINCOLOR
...
Part255.BrickColor = MAINRUINCOLOR
...
Part267.BrickColor = MAINRUINCOLOR
...
Part297.BrickColor = MAINRUINCOLOR
...
Part305.BrickColor = MAINRUINCOLOR
...
Part327.BrickColor = MAINRUINCOLOR
...
Part335.BrickColor = MAINRUINCOLOR
...
Part339.BrickColor = MAINRUINCOLOR
...
Part345.BrickColor = MAINRUINCOLOR
...
Part349.BrickColor = MAINRUINCOLOR
...
Part365.BrickColor = MAINRUINCOLOR
...
Part367.BrickColor = MAINRUINCOLOR
...
Part373.BrickColor = MAINRUINCOLOR
...
Part375.BrickColor = MAINRUINCOLOR
...
Part387.BrickColor = MAINRUINCOLOR
...
Part395.BrickColor = MAINRUINCOLOR
...
Part403.BrickColor = MAINRUINCOLOR
...
Part407.BrickColor = MAINRUINCOLOR
...
ModeOfGlitch = 1
storehumanoidWS = 16
newTheme("rbxassetid://146778702",48.6,1,1.25)
RecolorTextAndRename("do the mario",Color3.new(0.25,0,0),Color3.new(1,0,0),"Antique")
...
function EndGROUND()
	attack = true
hum.WalkSpeed = 0
bosschatfunc("カドモス！",MAINRUINCOLOR.Color,1)
--CFuncs["Sound"].Create("rbxassetid://838392947", root, 10, 1)
CFuncs["Sound"].Create("rbxassetid://1368598393", root, 10, 1)
...
CFuncs["Sound"].Create("rbxassetid://136007472", root, 10,1)
CFuncs["Sound"].Create("rbxassetid://847061203", root, 2, 1)
...
local radm = math.random(1,3)
if radm == 1 then
bosschatfunc("Heaven is coming for you.",MAINRUINCOLOR.Color,3)
elseif radm == 2 then
bosschatfunc("How about this?",MAINRUINCOLOR.Color,2)
elseif radm == 3 then
bosschatfunc("Swarm!",MAINRUINCOLOR.Color,2)
end
...
local rval = 0
local eval = 1
CFuncs["Sound"].Create("rbxassetid://136007472", root, 10,0.2)
for i = 0,55,0.1 do
swait()
...
obj2.Size = obj2.Size + vt(0.2,0.2,0.2)
...
cfor.CFrame = obj2.CFrame
slash(math.random(50,60)/10,5,true,"Round","Add","In",obj2.CFrame*CFrame.Angles(math.rad(math.random(-160,160)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,0.01,1),math.random(-300,-100)/250,BrickColor.new("Really red"))
slash(math.random(50,60)/10,5,true,"Round","Add","In",obj2.CFrame*CFrame.Angles(math.rad(math.random(-160,160)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360))),vt(1,0.01,1),math.random(-300,-100)/250,BrickColor.new("Toothpaste"))
...
function lovetaunt()
		bosschatfunc("Don't judge me by my looks!",MAINRUINCOLOR.Color,2)
...
function original_turnon()
	original = true
	galaxy = false
	chatfunc("Original SGR is on.",MAINRUINCOLOR.Color,"Inverted","Arcade",2)
	edit = false
end

function original_turnoff()
	original = false
	galaxy = false
	chatfunc("Original SGR is off.",MAINRUINCOLOR.Color,"Inverted","Arcade",2)
	edit = true
end

function galaxy_turnon()
	original = false
	galaxy = true
	chatfunc("Cytus is on.",MAINRUINCOLOR.Color,"Inverted","Arcade",2)
	edit = false
end

function galaxy_turnoff()
	original = false
	galaxy = false
	chatfunc("Cytus is off.",MAINRUINCOLOR.Color,"Inverted","Arcade",2)
	edit = true
end
...
rainbowmode = false
chaosmode = false
newTheme("rbxassetid://146778702",48.6,1,1.85)
RecolorTextAndRename3("Status: EDIT",Color3.new(0.25,0,0),Color3.new(1,0,0),"Arcade")
RecolorTextAndRename2("Information: This guy was a plumber on a adventure to find his princess called Peach, He searched her In castles every day, Luigi helped him, and (MESSAGE DIRTY, CANT READ, LEFT MESSAGE: He Was also making a dance, after 1 hour of making it and resting he got memed.", Color3.new(0.25,0,0),Color3.new(1,0,0),"Arcade")
RecolorTextAndRename("do the mario",Color3.new(0.25,0,0),Color3.new(1,0,0),"Antique")
MAINRUINCOLOR = BrickColor.new("Really red")
RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true,false)
end
...
RecolorTextAndRename2("Information: The Lost Pillarmen, While he was looking for his brothers pillarmen, he found out he turned blue. Some facts say that is because hes a magical stone. The facts WERE right.",Color3.new(0,1,1),Color3.new(1,1,1),"Arcade")
RecolorTextAndRename("blue pillarmen",Color3.new(0,1,1),Color3.new(1,1,1),"Code")
newTheme("rbxassetid://627848963",0,1,1.45)
MAINRUINCOLOR = BrickColor.new("Toothpaste")
RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true,false)
end
...
RecolorTextAndRename2("Information: Literally a hacker named XXpRoKillERXX was found hacking, he was using x-ray, auto build, afk arena, etc. He was called the most biggest hacker in minecraft, Once a day he hacks a new account and gets the password in so the user cant login.",Color3.new(0,0,0),Color3.new(0.35,0,1),"Arcade")
RecolorTextAndRename("i hack your minecraft",Color3.new(0,0,0),Color3.new(0.35,0,1),"Antique")
newTheme("rbxassetid://296277143",58.15,0.98,1.85)
MAINRUINCOLOR = BrickColor.new("Royal purple")
RecolorThing(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true,false)
end
...
RecolorTextAndRename2("HElleEP HELp HEWLp HEP HELHPE HLEP HELP HELP HELP HELP HELP",Color3.new(0,0,0),Color3.new(1,1,1),"Arcade")
RecolorTextAndRename("INSANITY",Color3.new(0,0,0),Color3.new(1,1,1),"Arcade")
newTheme("rbxassetid://493786497",0,0.85,1.35)
...
RecolorTextAndRename2("Information: Sigh, why did they made me... Okay, so, This WOMAN is not a hero, shes a hero only in the game, Please understand we cant give Info about a character from a game.",Color3.new(1,1,1),Color3.new(1,1,0.5),"Arcade")
RecolorTextAndRename("mercy",Color3.new(1,1,1),Color3.new(1,1,0.5),"SciFi")
newTheme("rbxassetid://1049730431",0,1.02,1.85)
...
chaosmode = false
RecolorTextAndRename3("Status: EDIT",Color3.new(0,0,0),Color3.new(1,1,1),"Arcade")
RecolorTextAndRename2("Information: You all might know the I PLAY POKEMON GO song, Well... This guy is the one that is obsessed with the game. He's the one thats called... Uh lemme find...  Pokemon Hero...? What is this? AUTHOR WHAT IS THIS NONSENSE?! TURN THE VOICE OFF!!! *Lost signal*",Color3.new(0,0,0),Color3.new(1,1,1),"Arcade")
...
rainbowmode = false
chaosmode = false
RecolorTextAndRename3("Status: EDIT",Color3.new(1,1,1),BrickColor.new("Alder").Color,"Arcade")
RecolorTextAndRename2("Information: NO INFORMATION FOUND",Color3.new(1,1,1),BrickColor.new("Alder").Color,"Arcade")
RecolorTextAndRename("donkey kong",Color3.new(1,1,1),BrickColor.new("Alder").Color,"Code")
newTheme("rbxassetid://512028153",0,1.01,1.85)
...
RecolorTextAndRename2("Information: WHY DO I HAVE TO GIVE INFORMATION ABOUT THIS GODAMN?!!?!?! AUTHOR WHY? IM GOING TO HECKING SLICE YOU, INTO- *Lost signal*",Color3.new(0,1,0),Color3.new(0.8,1,0.5),"Arcade")
...
if message:sub(1,8) == "PURITY V" and attack == false and ModeOfGlitch ~= 239567239458702938457 then
...
RecolorTextAndRename2("Information: The Second of the gods. REALITY's Brother. Has the infinite Power. Even thanos cannot beat him with all the crystals.",BrickColor.new("Dark indigo").Color,BrickColor.new("Toothpaste").Color,"Arcade")
...
MAINRUINCOLOR = BrickColor.new("Toothpaste")
bosschatfunc("Didn't thought i was coming, Right?",MAINRUINCOLOR.Color,6)
...
plr.Chatted:connect(function(message)
if message:sub(1,13) == "UG:DYSMORPHIC" and attack == false and ModeOfGlitch ~= 150 then
               ModeOfGlitch = 150
storehumanoidWS = 50
hum.WalkSpeed = 50
rainbowmode = false
...
RecolorTextAndRename2("Information: NO INFORMATION FOUND",BrickColor.new("Really black").Color,BrickColor.new("Really red").Color,"Arcade")
...
plr.Chatted:Connect(function(message)
if message:sub(1,8) == "MURDERER" and attack == false and ModeOfGlitch ~= 2846710909109911111111111 then
...
CFuncs["Sound"].Create("rbxassetid://1664711478", char, 6, 0.5)]]--
RecolorTextAndRename3("Status: EDIT",BrickColor.new("Really red").Color,BrickColor.new("Dark indigo").Color,"Arcade")
RecolorTextAndRename2("Information: loST muRDEREr On ThE WanTED CRIminALs CosTIGnG 1861% moReE Than THe RiuChEST PERoSn/?!?!?!",BrickColor.new("Really red").Color,BrickColor.new("Really red").Color,"Antique")
...
bosschatfunc("TaSTE thE BloOd, IS muRDER, Was iT wORTh IT?1?",MAINRUINCOLOR.Color,3)
...
MAINRUINCOLOR = BrickColor.new("Bright red")
bosschatfunc("iIIIIII amM nTOTHiNG forT THE EOWlRFDDDDD..",MAINRUINCOLOR.Color,6)
RecolorThing(BrickColor.new("Bright red"),BrickColor.new("Bright red"),MAINRUINCOLOR,MAINRUINCOLOR,BrickColor.new("Really red"),1,MAINRUINCOLOR,1,MAINRUINCOLOR,true,false)
end


Player.Chatted:connect(function(msg)
	if msg:sub(1,11) == "NEPTUNIAN V" and ModeOfGlitch ~= 99 then
				ModeOfGlitch = 99
storehumanoidWS = 16
hum.WalkSpeed = 16
chaosmode = false
...
RecolorTextAndRename2("Information: That old good game, you really gotta play it, anyway is a girl that had a sword but she lost it, BUT... She can use her 8-bit sword. So thats something good, i quess?",BrickColor.new("Royal purple").Color,BrickColor.new("Bright blue").Color,"Arcade")
...
bosschatfunc("Nya!",MAINRUINCOLOR.Color,1)
...
CFuncs["Sound"].Create("rbxassetid://1664711478", char, 6, 0.5)]]--
RecolorTextAndRename3("Status: EDIT",BrickColor.new("Dark indigo").Color,BrickColor.new("Really red").Color,"Arcade")
RecolorTextAndRename2("Information: The true god among us has come, The true leader of every kind, Shalt you not touch him. The True Hero of breaking memes and making people normal.",BrickColor.new("Dark indigo").Color,BrickColor.new("Really red").Color,"Arcade")
...
MAINRUINCOLOR = BrickColor.new("Dark indigo")
bosschatfunc("No fun is coming now.",MAINRUINCOLOR.Color,6)
disably = false
...
RecolorTextAndRename2("Information: Why... Why author is so strange... Sigh, Okay so that thomas guy is a cartoon hes a meme and hes a train. Do you got it now? AUTHOR UNHIRE ME PLEASE IM GETTING SICK OF THIS",BrickColor.new("Royal purple").Color,BrickColor.new("Really blue").Color,"Arcade")
...
MAINRUINCOLOR = BrickColor.new("Royal purple")
bosschatfunc("...",MAINRUINCOLOR.Color,5)
...
RecolorTextAndRename2("Information: The second lost brother of REALITY, He was lost around 5 years in the forest, his Old brother couldn't notice him because then he was blind, He then recovered and got a great power.",BrickColor.new("Alder").Color,BrickColor.new("Lilac").Color,"Arcade")
...
RecolorTextAndRename2("Information: mario got tortured with memes and... Well you see what he is now.",Color3.new(0.1,0,0),Color3.new(0.25,0,0),"Arcade")
RecolorTextAndRename("overdose",Color3.new(0.1,0,0),Color3.new(0.25,0,0),"Antique")
newTheme("rbxassetid://574430131",0,1,2)
MAINRUINCOLOR = BrickColor.new("Bright red")
bosschatfunc("AH TO MANY MEMES",MAINRUINCOLOR.Color,4)
RecolorThing(MAINRUINCOLOR,BrickColor.new("Really black"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true,false)
end
	if k == "h" and ModeOfGlitch ~= 7437562987063 and attack == false then
...
RecolorTextAndRename2("Information: play uno",BrickColor.new("Dark indigo").Color,Color3.new(0,0,0),"Arcade")
RecolorTextAndRename("when you swear in roblox",Color3.new(0.5,0,0),BrickColor.new("Really black").Color,"Arcade")
...
chaosmode = false
RecolorTextAndRename3("Status: EDIT",BrickColor.new("Dark indigo").Color,Color3.new(0,0,0),"Arcade")
RecolorTextAndRename2("Information: NO INFORMATION",BrickColor.new("Dark indigo").Color,Color3.new(0,0,0),"Arcade")
...
bosschatfunc("CHAOS, CHAOS!",MAINRUINCOLOR.Color,2)
RecolorThing(MAINRUINCOLOR,BrickColor.new("Really black"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true,false)
end


plr.Chatted:connect(function(message)
if message:sub(1,7) == "hehe..." and attack == false and ModeOfGlitch ~= 999 then
	ModeOfGlitch = 999
	storehumanoidWS = 16
hum.WalkSpeed = 16
rainbowmode = false
...
RecolorTextAndRename2("Information: You wont get any information about me, senpai.",BrickColor.new("Hot pink").Color,BrickColor.new("Pink").Color,"Arcade")
...
bosschatfunc("hehe...",MAINRUINCOLOR.Color,3)
...
plr.Chatted:connect(function(message)
if message:sub(1,15) == "UG:RECALCITRANT" and attack == false and ModeOfGlitch ~= 50 then
               ModeOfGlitch = 50
storehumanoidWS = 50
hum.WalkSpeed = 50
rainbowmode = false
...
RecolorTextAndRename2("Information: The thanos from the AVENGERS... Well he used time crystal and got in ROBLOXIAN's time. Now hes just using his own gauntlet to make wings.",Color3.new(1,1,1),Color3.new(1,0,0),"Arcade")
...
rainbowmode = false
chaosmode = false
RecolorTextAndRename3("Status: EDIT",Color3.new(0.25,0,0.1),BrickColor.new("Brown").Color,"Arcade")
RecolorTextAndRename2("Information: Why, IS A GODAMN GAME AHAHAHAHA DO YOU GET IT GODAMN AUTHOR SERIOUSLY THIS IS SICKENING.",BrickColor.new("Brown").Color,Color3.new(0,0,0),"Arcade")
RecolorTextAndRename("fortnut",Color3.new(0.25,0,0.1),BrickColor.new("Brown").Color,"Antique")
newTheme("rbxassetid://1692341659",0,1,4)
MAINRUINCOLOR = BrickColor.new("Brown")
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)
RecolorThing(MAINRUINCOLOR,BrickColor.new("Brown"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true,false)
end
...
RecolorTextAndRename2("Information: The Most First lost brother of REALITY. He was the one to help him make the world, Asked god for permission to make him help him and jesus, Make people feel better and more.",Color3.new(0.75,0.9,1),BrickColor.new("Pink").Color,"Arcade")
...
RecolorTextAndRename2("Information: If you know GALAXY GLITCHER NoobyGames12 Made, You might know the BINARY. He had enough power to go BINARY_X, And with the power he got from REALITY, He made it and now hes the other in REALITY's team.",BrickColor.new("Earth green").Color,BrickColor.new("Institutional white").Color,"Arcade")
...
bosschatfunc("Remember me?",MAINRUINCOLOR.Color,4)
warnedpeople(modet.Text,modet.Font,modet.TextColor3,modet.TextStrokeColor3)
...
RecolorTextAndRename2("Information: Self explanatory on who he is. Fact: He is a Halloween Skeleton.",BrickColor.new("Really black").Color,BrickColor.new("Navy blue").Color,"Arcade")
...
rainbowmode = false
chaosmode = false
RecolorTextAndRename3("Status: EDIT",Color3.new(0.5,1,1),BrickColor.new("Deep orange").Color,"Arcade")
RecolorTextAndRename2("Information: You know... Despacito virus? Well this guy got the virus and now hes always singing minecraft-cito or despacito. He usually always only goes somewhere peaceful and sings despacito.",Color3.new(0.5,1,1),BrickColor.new("Deep orange").Color,"Arcade")
RecolorTextAndRename("DESPACITO",Color3.new(0.5,1,1),BrickColor.new("Deep orange").Color,"Antique")
newTheme("rbxassetid://2141955311",0,1,2)
MAINRUINCOLOR = BrickColor.new("Pastel green")
disably = false
warnedpeople("despacito11!","Arcade",BrickColor.new("Toothpaste").Color,BrickColor.new("Deep orange").Color)
disably = true
...
plr.Chatted:connect(function(message)
if message:sub(1,10) == "Visualiser" and attack == false and ModeOfGlitch ~= 111 then
                 ModeOfGlitch = 111
storehumanoidWS = 135
hum.WalkSpeed = 135
rainbowmode = false
...
RecolorTextAndRename3("Status: EDIT",Color3.new(0,0,0),BrickColor.new("Medium stone grey").Color,"Arcade")
RecolorTextAndRename2("Information: O R  D I N A R Y D A  Y S .",Color3.new(0,0,0),BrickColor.new("Medium stone grey").Color,"Arcade")
...
modet.TextStrokeTransparency = 1
		...
		if k == "k" and attack == false and galaxy ~= true then
	galaxy_turnon()
		elseif k == "k" and galaxy ~= false then
	galaxy_turnoff()
		end
...
if k == "b" and attack == false and equipped == false then
	equip()
elseif k == "b" and attack == false and equipped == true then
   unequip()
end
if k == "z" and ModeOfGlitch == 9155165657475643856000011111 and attack == false then
	taunt()
end
if k == "j" and attack == false and original == false then
	original_turnon()
elseif k == "j" and attack == false and original == true then
	original_turnoff()
end
...
imgca.ImageTransparency = 1
elseif ModeOfGlitch == 1264532489 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 4367677813 or ModeOfGlitch == 9999999921111 or ModeOfGlitch == 999999999556 or ModeOfGlitch == 765688533321 or ModeOfGlitch == 88893333388 or ModeOfGlitch == 808080808080808080808080  or ModeOfGlitch == 239567239458702938457 or ModeOfGlitch == 2846710909109911111111111 or  ModeOfGlitch == 2000000000 then
...
coroutine.resume(coroutine.create(function()
if galaxy == false then
if ModeOfGlitch ~= 1264532489 and ModeOfGlitch ~= 55469696922 and ModeOfGlitch ~= 4367677813 and ModeOfGlitch ~= 9999999921111 and ModeOfGlitch ~= 999999999556 and ModeOfGlitch ~= 765688533321 and ModeOfGlitch ~= 8889 and ModeOfGlitch ~= 664663666 and ModeOfGlitch ~= 88893333388 and ModeOfGlitch ~= 808080808080808080808080 and ModeOfGlitch ~= 239567239458702938457 and ModeOfGlitch ~= 50 and ModeOfGlitch ~= 150 and ModeOfGlitch ~= 1 and ModeOfGlitch ~= 2 and ModeOfGlitch ~= 3 and ModeOfGlitch ~= 4 and ModeOfGlitch ~= 5 and ModeOfGlitch ~= 6 and ModeOfGlitch ~= 7 and ModeOfGlitch ~= 8 and ModeOfGlitch ~= 9 and ModeOfGlitch ~= 2846710909109911111111111 and ModeOfGlitch ~= 666 and ModeOfGlitch ~= 999 and ModeOfGlitch ~= 99 and ModeOfGlitch ~= 10 and ModeOfGlitch ~= 2000000000 then
lwing1weld.C1=clerp(lwing1weld.C1,cf(2,0,0)*angles(math.rad(0),math.rad(0),math.rad(0))*angles(math.rad(5 + 25 * math.cos(sine / 32)),math.rad(0),math.rad(12.5 + 5 * math.cos(sine / 32))),.3)
lwing2weld.C1=clerp(lwing2weld.C1,cf(3,1,0)*angles(math.rad(0),math.rad(0),math.rad(0))*angles(math.rad(10 + 30 * math.cos(sine / 32)),math.rad(0),math.rad(25 + 7.5 * math.cos(sine / 32))),.3)
lwing3weld.C1=clerp(lwing3weld.C1,cf(3.75,2,0)*angles(math.rad(0),math.rad(0),math.rad(0))*angles(math.rad(15 + 40 * math.cos(sine / 32)),math.rad(0),math.rad(37.5 + 10 * math.cos(sine / 32))),.3)
rwing1weld.C1=clerp(rwing1weld.C1,cf(-2,0,0)*angles(math.rad(0),math.rad(0),math.rad(0))*angles(math.rad(5 + 20 * math.cos(sine / 32)),math.rad(0),math.rad(-12.5 - 5 * math.cos(sine / 32))),.3)
rwing2weld.C1=clerp(rwing2weld.C1,cf(-3,1,0)*angles(math.rad(0),math.rad(0),math.rad(0))*angles(math.rad(10 + 25 * math.cos(sine / 32)),math.rad(0),math.rad(-25 - 7.5 * math.cos(sine / 32))),.3)
rwing3weld.C1=clerp(rwing3weld.C1,cf(-3.75,2,0)*angles(math.rad(0),math.rad(0),math.rad(0))*angles(math.rad(15 + 30 * math.cos(sine / 32)),math.rad(0),math.rad(-37.5 - 10 * math.cos(sine / 32))),.3)
elseif ModeOfGlitch == 50 or ModeOfGlitch == 150 or ModeOfGlitch == 1 or ModeOfGlitch == 2 or ModeOfGlitch == 3 or ModeOfGlitch == 4 or ModeOfGlitch == 5 or ModeOfGlitch == 6 or ModeOfGlitch == 7 or ModeOfGlitch == 8 or ModeOfGlitch == 9 or ModeOfGlitch == 2846710909109911111111111 or ModeOfGlitch == 666 or ModeOfGlitch == 999 and galaxy ~= true then
lwing1weld.C1=clerp(lwing1weld.C1,cf(6.5 + 0.01 * math.cos(sine / 100),1.5 + 0.75 * math.cos(sine / 85),0)*angles(math.rad(0 + 2 * math.cos(sine / 50)),math.rad(0 - 2 * math.cos(sine / 36)),math.rad(90 + 479600 * math.cos(sine / 5960))),.3)
lwing2weld.C1=clerp(lwing2weld.C1,cf(0 + 0.5 * math.cos(sine / 400),-1 + 0.75 * math.cos(sine / 95),0)*angles(math.rad(0 + 2 * math.cos(sine / 70)),math.rad(0 - 2 * math.cos(sine / 37)),math.rad(-147.5 + 39600 * math.cos(sine / 960))),.3)
lwing3weld.C1=clerp(lwing3weld.C1,cf(0 + 0.5 * math.cos(sine / 400),-1 + 0.75 * math.cos(sine / 95),0)*angles(math.rad(0 + 2 * math.cos(sine / 60)),math.rad(0 - 2 * math.cos(sine / 51)),math.rad(-32.5 + 39600 * math.cos(sine / 960))),.3)
rwing1weld.C1=clerp(rwing1weld.C1,cf(6.5 + 0.01 * math.cos(sine / 100),-1.5 + 0.75 * math.cos(sine / 85),0)*angles(math.rad(0 + 2 * math.cos(sine / 50)),math.rad(0 - 2 * math.cos(sine / 36)),math.rad(-90 + 479600 * math.cos(sine / 5960))),.3)
rwing2weld.C1=clerp(rwing2weld.C1,cf(0 + 0.5 * math.cos(sine / 400),-1 + 0.75 * math.cos(sine / 95),0)*angles(math.rad(0 + 2 * math.cos(sine / 80)),math.rad(0 - 2 * math.cos(sine / 47)),math.rad(-147.5 + 39600 * math.cos(sine / 960))),.3)
rwing3weld.C1=clerp(rwing3weld.C1,cf(0 + 0.5 * math.cos(sine / 400),-1 + 0.75 * math.cos(sine / 95),0)*angles(math.rad(0 + 2 * math.cos(sine / 70)),math.rad(0 - 2 * math.cos(sine / 61)),math.rad(-32.5 + 39600 * math.cos(sine / 960))),.3)
elseif ModeOfGlitch == 55469696922 or ModeOfGlitch == 4367677813 or ModeOfGlitch == 9999999921111 or ModeOfGlitch == 239567239458702938457 or ModeOfGlitch == 50 and galaxy ~= true then
...
elseif ModeOfGlitch == 8889 or ModeOfGlitch == 664663666 or ModeOfGlitch == 88893333388 or ModeOfGlitch == 99 then
...
lwing1weld.C1=clerp(lwing1weld.C1,cf(0 + 7.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),0)*angles(math.rad(0 + 3 * math.cos(sine / 50)),math.rad(0 - 2 * math.cos(sine / 36)),math.rad(90 + 3600 * math.cos(sine / 360))),.3)
lwing2weld.C1=clerp(lwing2weld.C1,cf(0 + 7.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),0)*angles(math.rad(0 + 3 * math.cos(sine / 70)),math.rad(0 - 2 * math.cos(sine / 37)),math.rad(147.5 + 3600 * math.cos(sine / 360))),.3)
lwing3weld.C1=clerp(lwing3weld.C1,cf(0 + 7.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),0)*angles(math.rad(0 + 3 * math.cos(sine / 60)),math.rad(0 - 2 * math.cos(sine / 51)),math.rad(32.5 + 3600 * math.cos(sine / 360))),.3)
rwing1weld.C1=clerp(rwing1weld.C1,cf(0 + 7.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),0)*angles(math.rad(0 + 3 * math.cos(sine / 50)),math.rad(0 - 2 * math.cos(sine / 36)),math.rad(-90 + 3600 * math.cos(sine / 360))),.3)
rwing2weld.C1=clerp(rwing2weld.C1,cf(0 + 7.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),0)*angles(math.rad(0 + 3 * math.cos(sine / 70)),math.rad(0 - 2 * math.cos(sine / 37)),math.rad(-147.5 + 3600 * math.cos(sine / 360))),.3)
rwing3weld.C1=clerp(rwing3weld.C1,cf(0 + 7.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),0)*angles(math.rad(0 + 3 * math.cos(sine / 60)),math.rad(0 - 2 * math.cos(sine / 51)),math.rad(-32.5 + 3600 * math.cos(sine / 360))),.3)
lwing4weld.C1=clerp(lwing4weld.C1,cf(0 - 15.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),-1)*angles(math.rad(0 + 1 * math.cos(sine / 50)),math.rad(0 - 2 * math.cos(sine / 36)),math.rad(90 - 3600 * math.cos(sine / 360))),.3)
lwing5weld.C1=clerp(lwing5weld.C1,cf(0 - 15.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),-1)*angles(math.rad(0 + 1 * math.cos(sine / 70)),math.rad(0 - 2 * math.cos(sine / 37)),math.rad(147.5 - 3600 * math.cos(sine / 360))),.3)
lwing6weld.C1=clerp(lwing6weld.C1,cf(0 - 15.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),-1)*angles(math.rad(0 + 1 * math.cos(sine / 60)),math.rad(0 - 2 * math.cos(sine / 51)),math.rad(32.5 - 3600 * math.cos(sine / 360))),.3)
rwing4weld.C1=clerp(rwing4weld.C1,cf(0 - 15.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),-1)*angles(math.rad(0 + 1 * math.cos(sine / 50)),math.rad(0 - 2 * math.cos(sine / 36)),math.rad(-90 - 3600 * math.cos(sine / 360))),.3)
rwing5weld.C1=clerp(rwing5weld.C1,cf(0 - 15.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),-1)*angles(math.rad(0 + 1 * math.cos(sine / 70)),math.rad(0 - 2 * math.cos(sine / 37)),math.rad(-147.5 - 3600 * math.cos(sine / 360))),.3)
rwing6weld.C1=clerp(rwing6weld.C1,cf(0 - 15.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),-1)*angles(math.rad(0 + 1 * math.cos(sine / 60)),math.rad(0 - 2 * math.cos(sine / 51)),math.rad(-32.5 - 3600 * math.cos(sine / 360))),.3)
end
end
if galaxy == true then
...
coroutine.resume(coroutine.create(function()
if ModeOfGlitch == 6 or ModeOfGlitch == 8 or ModeOfGlitch == 664663666 or ModeOfGlitch == 1264532489 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 4367677813 or ModeOfGlitch == 9999999921111 or ModeOfGlitch == 999999999556 or ModeOfGlitch == 8889 or ModeOfGlitch == 765688533321 or ModeOfGlitch == 88893333388 or ModeOfGlitch == 808080808080808080808080 or ModeOfGlitch == 239567239458702938457 or ModeOfGlitch == 50 or ModeOfGlitch == 150 or ModeOfGlitch == 2000000000 then
...
if ModeOfGlitch == 1264532489 or ModeOfGlitch == 88893333388 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 4367677813 or ModeOfGlitch == 9999999921111 or ModeOfGlitch == 999999999556 or ModeOfGlitch == 765688533321 or ModeOfGlitch == 808080808080808080808080 or ModeOfGlitch == 2846710909109911111111111 or ModeOfGlitch == 2000000000 then
...
RW.C0=clerp(RW.C0,cf(1.43,0.45 + 0.235 * math.cos(sine / 15),0)*angles(math.rad(12),math.rad(3),math.rad(5)),.1)
LW.C0=clerp(LW.C0,cf(-1.43,0.6 + 0.235 * math.cos(sine / 15),0)*angles(math.rad(9),math.rad(4),math.rad(-5)),.1)
...
RW.C0=clerp(RW.C0,cf(1,0.45 + 0.025 * math.cos(sine / 45),-0.5)*angles(math.rad(62 + 6 * math.cos(sine / 72)),math.rad(3 - 2 * math.cos(sine / 58)),math.rad(-82 + 2 * math.cos(sine / 45))),.1)
LW.C0=clerp(LW.C0,cf(-1,0.6 + 0.025 * math.cos(sine / 45),-0.5)*angles(math.rad(89 - 7 * math.cos(sine / 66)),math.rad(4 - 3 * math.cos(sine / 59)),math.rad(67 - 4 * math.cos(sine / 45))),.1)
...
elseif ModeOfGlitch == 50 or ModeOfGlitch == 150 then
RH.C0=clerp(RH.C0,cf(1,-1 - 0.05 * math.cos(sine / 15),0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-6),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(1 - 2 * math.cos(sine / 32))),.1)
LH.C0=clerp(LH.C0,cf(-1,-1 - 0.05 * math.cos(sine / 15),0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-0.5),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(-1 + 2 * math.cos(sine / 32))),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,-0.01 + 0.02 * math.cos(sine / 15),0 + 0.05 * math.cos(sine / 15))*angles(math.rad(1 - 2 * math.cos(sine / 15)),math.rad(0),math.rad(0 + 1 * math.cos(sine / 22))),.1)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(35 - 2 * math.cos(sine / 15)),math.rad(0 + 2 * math.cos(sine / 28)),math.rad(0 + 1 * math.cos(sine / 23))),.1)
...
LW.C0=clerp(LW.C0,cf(-1.5,0.5 + 0.025 * math.cos(sine / 45),0)*angles(math.rad(165 - 3 * math.cos(sine / 73) + math.random(-1,1)),math.rad(2 - 1 * math.cos(sine / 55) + math.random(-1,1)),math.rad(21 - 3 * math.cos(sine / 45) + math.random(-1,1))),.6)
end
...
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(25 - 2 * math.cos(sine / 37)),math.rad(0 + 1 * math.cos(sine / 58)),math.rad(0 + 2 * math.cos(sine / 53))),.1)
RW.C0=clerp(RW.C0,cf(1.5,0.5 + 0.025 * math.cos(sine / 45),0)*angles(math.rad(30 + 2 * math.cos(sine / 74)),math.rad(1 - 1 * math.cos(sine / 53)),math.rad(0 + 1 * math.cos(sine / 45))),.1)
...
RH.C0=clerp(RH.C0,cf(1,-0.4,-0.5)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(8 - 6 * math.cos(sine / 67)),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(-18 - 5 * math.cos(sine / 32))),.1)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-15 - 8 * math.cos(sine / 74)),math.rad(0 - 1 * math.cos(sine / 56)),math.rad(31 + 8 * math.cos(sine / 38))),.1)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0 + 0.02 * math.cos(sine / 32),2 + 0.35 * math.cos(sine / 32))*angles(math.rad(-21 - 2 * math.cos(sine / 32)),math.rad(8),math.rad(0)),.1)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(25 - 6 * math.cos(sine / 37)),math.rad(-14 + 5 * math.cos(sine / 58)),math.rad(0 + 2 * math.cos(sine / 53))),.1)
RW.C0=clerp(RW.C0,cf(1.5,0.5 + 0.025 * math.cos(sine / 45),0)*angles(math.rad(-24 + 9 * math.cos(sine / 72)),math.rad(3 - 5 * math.cos(sine / 58)),math.rad(38 + 7 * math.cos(sine / 45))),.1)
LW.C0=clerp(LW.C0,cf(-0.8,0.35 + 0.025 * math.cos(sine / 45),-0.75)*angles(math.rad(160 - 2 * math.cos(sine / 66)),math.rad(5 - 8 * math.cos(sine / 59)),math.rad(87 - 3 * math.cos(sine / 45))),.1)
