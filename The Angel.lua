...
-- Credits to Nebula..(Sigma, Very super PRO) ---------

-- Script Source
script=game:GetObjects("rbxassetid://7775496800")[1].Convert
-- Soundtrack
 if not isfile("Angel.mp3") then 
	writefile("Angel.mp3",game:HttpGet("https://github.com/gObl00x/Soundtracks/raw/refs/heads/main/Angel.mp3"))
 end
 
    -- Some additional things from the great Nebula
...
local DamageColor = BrickColor.new'New Yeller'
 local Music = Instance.new("Sound")
  Music.Name = "Music"
    Music.SoundId = getcustomasset("Angel.mp3")
       Music.Parent = Char
         Music.Volume = 3
